...
const translations = {
  et: {
    ...
    hero_title2: "uue elu",
    hero_subtitle:
      "Restaureerime armastusega vana mööblit ning müüme ainulaadseid vintage mööblieksemplare. Iga ese räägib oma lugu.",
  ...
  en: {
    ...
    contact_subtitle: "If you have any questions, contact us!",
